...
#define Interrupt_detection_Pin GPIO_PIN_7
#define Interrupt_detection_GPIO_Port GPIOB
#define Interrupt_detection_EXTI_IRQn EXTI9_5_IRQn
...
#define Interrupt_for_LED_Pin GPIO_PIN_0
#define Interrupt_for_LED_GPIO_Port GPIOA
#define Interrupt_for_LED_EXTI_IRQn EXTI0_IRQn
